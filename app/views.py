...
def news_source(source_id):
    ...
    return render_template('newsSource.html', title=title,articles=articles,majorArticle=majorArticle,major2Article=major2Article,latestArticle=latestArticle)
